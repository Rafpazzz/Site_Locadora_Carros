...
class LocatariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locatario" do
    assert_difference("Locatario.count") do
      post locatarios_url, params: { locatario: { cpf: @locatario.cpf, nome: @locatario.nome } }
    end
  ...
  test "should update locatario" do
    patch locatario_url(@locatario), params: { locatario: { cpf: @locatario.cpf, nome: @locatario.nome } }
